...
import com.tautvydas.openglrenderingpractice.common.TextureHelper;
import com.tautvydas.openglrenderingpractice.common.shapes.Cube;

import javax.microedition.khronos.egl.EGLConfig;
import javax.microedition.khronos.opengles.GL10;

class BasicRenderer4 implements GLSurfaceView.Renderer {
    ...
    private int mTexturedProgramHandle;
    ...
    public BasicRenderer4(Context context) {
        mContext = context;
    }
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mTexturedProgramHandle = ShaderHelper.createProgram(mContext,
                R.string.shader_textured_vertex,
                R.string.shader_textured_fragment,
                new String[]{"a_Position", "a_Color", "a_Normal", "a_TexCoordinate"});

        mPointProgramHandle = ShaderHelper.createProgram(mContext,
                R.string.shader_point_vertex,
                R.string.shader_point_fragment,
                new String[]{"a_Position"});

        mTextureDataHandle1 = TextureHelper.loadTexture(mContext, R.drawable.rock_texture);
        mTextureDataHandle2 = TextureHelper.loadTexture(mContext, R.drawable.rock_texture_2);
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        GLES20.glUseProgram(mTexturedProgramHandle);

        // Set program handles for cube drawing.
        mMVPMatrixHandle = GLES20.glGetUniformLocation(mTexturedProgramHandle, "u_MVPMatrix");
        mMVMatrixHandle = GLES20.glGetUniformLocation(mTexturedProgramHandle, "u_MVMatrix");
        mLightPosHandle = GLES20.glGetUniformLocation(mTexturedProgramHandle, "u_LightPos");
        mTextureUniformHandle = GLES20.glGetUniformLocation(mTexturedProgramHandle, "u_Texture");
        mPositionHandle = GLES20.glGetAttribLocation(mTexturedProgramHandle, "a_Position");
        mColorHandle = GLES20.glGetAttribLocation(mTexturedProgramHandle, "a_Color");
        mNormalHandle = GLES20.glGetAttribLocation(mTexturedProgramHandle, "a_Normal");
        mTextureCoordinateHandle = GLES20.glGetAttribLocation(mTexturedProgramHandle, "a_TexCoordinate");
        ...
        cube1.draw(mPositionHandle, mColorHandle, mNormalHandle, mTextureCoordinateHandle);
        ...
        cube2.draw(mPositionHandle, mColorHandle, mNormalHandle, mTextureCoordinateHandle);
        ...
        cube3.draw(mPositionHandle, mColorHandle, mNormalHandle, mTextureCoordinateHandle);
        ...
        cube4.draw(mPositionHandle, mColorHandle, mNormalHandle, mTextureCoordinateHandle);

        cube5.setPosition(0.0f, 0.0f, -5.0f);
        cube5.setRotation(angleInDegrees1, 1.0f, 1.0f, 0.0f);
        updateUniforms(cube5);
        cube5.draw(mPositionHandle, mColorHandle, mNormalHandle, mTextureCoordinateHandle);
