package com.tautvydas.openglrenderingpractice.lesson2;
...
class BasicRenderer2 implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mPerVertexProgramHandle = createProgram(vertexShaderHandle, fragmentShaderHandle, new String[]{"a_Position", "a_Color", "a_Normal"});
